...
import 'package:quest_2/staff/scanconfirm_staff.dart';
...
class ScanQrStaffPage extends StatefulWidget {
  ScanQrStaffPage({Key? key}) : super(key: key);

  @override
  State<ScanQrStaffPage> createState() => _ScanQrStaffPageState();
}

class _ScanQrStaffPageState extends State<ScanQrStaffPage> {
  Barcode? result;
