...
import 'package:quest_2/staff_manager/scan_qr_staffmanager.dart';
...
class ActivityDetailsStaffManagerPage extends StatefulWidget {
  ActivityDetailsStaffManagerPage({Key? key}) : super(key: key);

  @override
  State<ActivityDetailsStaffManagerPage> createState() =>
      _ActivityDetailsStaffManagerPageState();
}

class _ActivityDetailsStaffManagerPageState
    extends State<ActivityDetailsStaffManagerPage> {
  void initState() {
    fectc();
    super.initState();
  }
      ...
      onPressed: isBTNActive != true
          ? () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ScanQrStaffManagerPage()));
            }
          : null,
      child: Container(
