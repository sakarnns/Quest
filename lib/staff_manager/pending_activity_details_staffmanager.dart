...
class PendingActivityDetailsStaffManagerNobtnPage extends StatefulWidget {
  ...
  @override
  State<PendingActivityDetailsStaffManagerNobtnPage> createState() =>
      _PendingActivityDetailsStaffManagerNobtnPageState();
}

class _PendingActivityDetailsStaffManagerNobtnPageState
    extends State<PendingActivityDetailsStaffManagerNobtnPage> {
  void initState() {
    fectc();
    super.initState();
  }
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                            ...
                            borderRadius:
                                new BorderRadius.all(Radius.circular(8.0))),
                        child: staffmanagerDetailAreanobtn(),
                      ),
                      SizedBox(
                        height: height(context: context) / 100,
                      ),
