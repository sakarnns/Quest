...
import 'package:quest_2/staff_manager/scanconfirm_staffmanager.dart';
...
class ScanQrStaffManagerPage extends StatefulWidget {
  ScanQrStaffManagerPage({Key? key}) : super(key: key);

  @override
  State<ScanQrStaffManagerPage> createState() => _ScanQrStaffManagerPageState();
}

class _ScanQrStaffManagerPageState extends State<ScanQrStaffManagerPage> {
  Barcode? result;
