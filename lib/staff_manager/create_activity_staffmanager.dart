...
import 'package:quest_2/staff_manager/preview_activity_staffmanager.dart';
import 'package:quest_2/styles/input_border.dart';
import 'package:quest_2/styles/size.dart';
import 'package:quest_2/user/preview_activity_user.dart';

class CreateActivityStaffManagerPage extends StatefulWidget {
  CreateActivityStaffManagerPage({Key? key}) : super(key: key);

  @override
  State<CreateActivityStaffManagerPage> createState() =>
      _CreateActivityStaffManagerPageState();
}
...
class _CreateActivityStaffManagerPageState
    extends State<CreateActivityStaffManagerPage> {
...
//Time End Picker
  ...
  void initState() {
    ...
    activitystaffmanager.eventname.clear();
    activitystaffmanager.eventstartdate.clear();
    activitystaffmanager.eventstarttime.clear();
    activitystaffmanager.eventenddate.clear();
    activitystaffmanager.eventendtime.clear();
    activitystaffmanager.eventtype.clear();
    activitystaffmanager.eventquantity.clear();
...
/*=="Event Name"==============================================================*/
                  ...
                  Padding(
                    ...
                    child: TextField(
                      controller: activitystaffmanager.eventname,
                      maxLength: 20,
...
/*=="Piont/Participants"======================================================*/
                  ...
                  Padding(
                    ...
                    child: TextField(
                      controller: activitystaffmanager.eventpointquantity,
                      keyboardType: TextInputType.number,
...
/*=="Tier Points"======================================================*/
                  ...
                  Padding(
                    ...
                    child: TextField(
                      controller: activitystaffmanager.eventtierpoint,
                      keyboardType: TextInputType.number,
                      inputFormatters: [LengthLimitingTextInputFormatter(2)],
                      decoration: InputDecoration(
                          focusedBorder: outlineInputBorder(),
                    ...
                    onPressed: eventnamecheck != null &&
                        ...
                        ? () {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        PreviewActivityStaffManagerPage()));
                          }
                        : null,
                    child: Text(
                      'Next',
