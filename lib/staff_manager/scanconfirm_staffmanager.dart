...
class ScanConfirmStaffManagerPage extends StatefulWidget {
  ScanConfirmStaffManagerPage({Key? key}) : super(key: key);

  @override
  State<ScanConfirmStaffManagerPage> createState() =>
      _ScanConfirmStaffManagerPage();
}

class _ScanConfirmStaffManagerPage extends State<ScanConfirmStaffManagerPage> {
  void initState() {
    fectc();
    super.initState();
  }
